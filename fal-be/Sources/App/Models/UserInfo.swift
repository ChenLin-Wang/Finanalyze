...
final class UserInfo: DModel, @unchecked Sendable {
    ...
    @Field(key: T[2].0)                             var firstName: String
    @Field(key: T[3].0)                             var middleName: String?
    @Field(key: T[4].0)                             var lastName: String
    ...
    @Field(key: T[12].0)                            var yearLvl: String?
    @Field(key: T[13].0)                            var school: String?
    ...
    init(
        userId: User.IDValue, firstName: String = "", lastName: String = "", middleName: String? = nil,
